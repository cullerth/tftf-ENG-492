<template>
  ...
  <div>
    <h4>for ENG 492:</h4>
    <h4><i>Filming in a Time of Emergency: Socio-Environmental Crisis and Alternative Futures Through Film</i></h4> 
    <p>
...
export default {
  ...
  methods: {
    parse() {
      var vue = this;
        this.papaparse.parse('https://raw.githubusercontent.com/cullerth/tftf-ENG-492/main/src/data/tftf_data_all.csv', {
        header: true,
        download: true, 
